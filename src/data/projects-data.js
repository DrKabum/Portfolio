const projects = [
  ...
  },
  {
    ...
    id: 2,
    link: 'https://github.com/DrKabum/Portfolio',
    preview: 'https://i.ibb.co/879hKy3/portfolio.png',
    description: "Want to know more about the website you're on ?",
    caption: "Wait, that's me!",
    articleParagraphs: [
      '## A React app',
      "This portfolio is baked with my favourite framework, React.js. It's made with love and some fully reusable components, made using a composition pattern. I'm regularly updating it as I'm learning new things with React or CSS.",
      "It was a great experience to build this project, as, being a small scale project, it's still a bigger project than most of the ones I've done previously with React.",
      "It's also fully responsive and has my face in pixel art on top.",
      '## Github workflow, and continuous deployment with Netlify',
      "Maybe you'll want to have a look on my repository for this project on GitHub? Just click on the link down below."
    ]
  },
  {
